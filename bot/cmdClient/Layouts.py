...
from .Format import h3, footnote

import random

_error_colour: Color = Color.from_rgb(197, 50, 17)
...
class GenericFullEmbed(LayoutView):
    def __init__(self, header: str, body: str, footer: str, thumbnail_url: str, accent_colour: Color) -> None:
    ...
    def __init__(self, body_text: str, datetime: str) -> None:
        ...
        container = Container(
            ...
            SectionWithThumbnail(
                body_text, 
                random.choice(IRASUTOYA_THUMBNAILS)),
            Footer(datetime),
