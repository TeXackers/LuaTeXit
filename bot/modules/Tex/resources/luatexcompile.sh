...
timeout 1m latexmk -lualatex -no-shell-escape "$1.tex" > texput_luatex.log #2>&1
...
timeout 10 convert -density 600 -quality 100 -depth 16 -gamma 2 -fuzz 1% -trim +repage "$1.pdf" -colorspace RGB +profile "icc" PNG64:"$1.png" >> /dev/null;
